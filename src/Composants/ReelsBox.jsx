import photo from '../items/croco.jpeg'
...
function MainVideo() {
    return(
        <div className="MainVideo">
            ...
            <img src={photo} alt="reelsVideo" className="ReelVideo"/>
            <div className="InfoReel">
                <div className="top-info-Reel">
                    <img src={photo} alt="profilePicture"/>
                    <p>Pseudo</p>
                    <button>Suivre</button>
                </div>
                <p className="Descriptionreel">Description </p>
                <div className="ButtonreelsMusic">
                    <button>
...
function LateralBar(){
    ...
    return(
        <div className='LateralBarre'>
            <ul>
                <li onClick={toggleLike} className='Heart'>
                {userLiked ? (
