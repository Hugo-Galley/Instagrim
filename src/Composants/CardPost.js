...
function DescriptionCard({nbrLike,nbrComment,description,timeStampPost}){
    // const now = new Date();
    // let tempsDepuisPost = (now.getHours() - new Date()) / 60
    // let TimeEcoule = "Il y'a " + tempsDepuisPost + " heures"
    // if (tempsDepuisPost <=1){
    //     tempsDepuisPost /= 60
         let TimeEcoule = "Il y'a " + 3 + " minutes"
         const [like, setLike] = useState(false);
         const [likesCount, setLikesCount] = useState(nbrLike);
        ...
        <div className='DescriptionCard'>
            ...
            <li>
                    {like ? (
                        ...
                        <button className='LikeButton' onClick={RemoveLike}>
